 ...
 */
function extractChannelConfig(tsContent: string): any {
 ...
 */
function extractScript(content: string, scriptType: string): string {
 ...
 */
function updateXmlWithConfig(xmlObj: any, config: any): void {
  // Update channel properties
  if (config.id) xmlObj.channel.id = config.id;
  if (config.name) xmlObj.channel.name = config.name;
  if (config.description) xmlObj.channel.description = config.description;
